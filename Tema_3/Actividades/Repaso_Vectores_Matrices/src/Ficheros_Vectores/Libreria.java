...
public class Libreria {
	...
	/**
	 * Funcion que ordena pares primero e impares despues dentro
	 * de un vector de reales y luego ordena los pares en orden ascendente
	 * y los impares en orden descendente
	 * @param v vector de reales
	 */
	...
	//------------Funciones ejercicio08------------
	/**
	 * Funcion que cuenta las veces que aparece un valor
	...
	public static int contarValor (int []v, int valor) {
		int contValor=0;
		for(int i=0;i<v.length;i++) {
			if (v[i]==valor) contValor++;
		}
		return contValor;
	}
	
	/**
	 * Funcion que calcula la media de veces que se repite
	 * un valor dentro de un vector
	 * @param v vector de enteros
	 * @return entero
	 */
	public static int mediaRepeticiones (int []v) {
		int suma =0;
		for (int i=0;i<v.length;i++) {
			suma +=v[i];
		}
	...
	//-----------Funciones ejercicio09-------------
	/**
	 * Funcion que determina si un vector tiene picos
	...
	public static boolean tienePico (int []v) {
		...
		if (contPicos>=1) {
			System.out.println("Número de picos: "+contPicos);
			return true;
		}
	...
	/**
	 * Funcion que determina si un vector tiene valles
	 * @param v vector de enteros
	 * @return boolean
	 */
	public static boolean tieneValle (int []v) {
		...
		if (contValles>=1) {
			System.out.println("Número de valles: "+contValles);
			return true;
		}
