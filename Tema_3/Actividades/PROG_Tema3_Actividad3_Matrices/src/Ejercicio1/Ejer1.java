...
public class Ejer1 {
	...
	public static void main(String[] args) {
		...
		*/
		int [][]m1= {{1,2},{-1,0},{-3,-1}};
		int [][]m2={{2,0,1},{-5,2,3}};
		int [][] producto =Libreria1.productoMatrices(m1, m2);
		Libreria1.mostrarMatriz(producto);
		
		
		/*
		int mat[][]=Libreria1.generarMatriz(filas,filas);
		...
		int []v2=Libreria1.diagonalizarMatriz(mat);
