...
public class Funciones {
	...
	/**
	 * Da la posicion de la primera ocurrencia de un digito
	 * teniendo en cuenta que la posicion empieza por 0.
	 * @param num: entero
	 * @param digito: entero
	 * @return entero
	 */
	...
	/**
	 * Agrega un digito a un numero por delante.
	 * @param num: entero
	 * @param digito: entero
	 * @return entero
	 */
